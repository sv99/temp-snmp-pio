...
SNMP_API_STAT_CODES AgentuinoClass::responsePdu(SNMP_PDU *pdu)
{
	...
	for ( uint32_t i = 0; i < pdu->OID.size; i++ ) {
	...
	for ( uint32_t i = 0; i < pdu->VALUE.size; i++ ) {
